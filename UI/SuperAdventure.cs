...
namespace UI
{
    public partial class SuperAdventure : Form
    {
        ...
        private void buttonbtnEast1_Click(object sender, EventArgs e)
        {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            buttonbtnEast1.Visible = (newLocation.LocationToEast != null);
            ...
            {
                //see if the player has already the quest
                        ...
                        foreach (QuestCompletionItem qci in newLocation.QuestAvailableHere.QuestCompletionItems)
                        {
                            ...
                            foreach (InventoryItem ii in _player.Inventory)
                            {
                                if (ii.Details.ID == qci.Details.ID)
                                {
                                    ...
                                    {
                                        // The player doesn't have enough items to complete the quest
                            ...
                            //If we don't find the item, set the var and stop looking for other
